...
<head>
    ...
    <title>Warlord Realm | Registeration Login Admin Panel</title>
    <link rel="shortcut icon" href="../asset/logo-min.png" type="image/x-icon">
    <link rel="stylesheet" href="../asset/style-registeration_admin_login_pange.css">
...
<body oncontextmenu="return false" ondragstart="return false;" ondrop="return false;">
    ...
    <div class="login-container">
        ...
        <h1 class="logo-text">Warlord Realm</h1>
        <p class="subtitle">Management Whitelist Applications</p>
